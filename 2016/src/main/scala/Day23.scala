...
object Day23 extends App:
  ...
  lazy val answer1 = CPU(instructions(), registers = Map("a" -> 7)).run.registers.valueOf("a")
  ...
  lazy val answer2 = CPU(instructions(patched = true), registers = Map("a" -> 12)).run.registers.valueOf("a")
