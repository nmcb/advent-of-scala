...
object Day20 extends App:
  ...
  case class Machine(modules: Map[Name, Module], sent: Vector[Message] = Vector.empty):
    ...
    def process(messages: Vector[Message], state: Machine): Machine =
  ...
  val answer1: Long = (1 to 1000).foldLeft(machine)((m,_) => m.press).result
  println(s"Answer day $day part 1: ${answer1} [${System.currentTimeMillis - start1}ms]")

  val start2: Long  = System.currentTimeMillis
  val answer2: Long = machine.solveRX
