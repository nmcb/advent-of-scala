...
class TestSolutions extends AnyFunSuite:
  ...
  test("Day19") {
    assertResult("DWNBGECOMY")(actual = Day19.answer1)
    assertResult(17228)(actual = Day19.answer2)
  }
  test("Day20") {
    assertResult(376)(actual = Day20.answer1)
    assertResult(574)(actual = Day20.answer2)
  }
  test("Day21") {
    assertResult(162)(actual = Day21.answer1)
    assertResult(2264586)(actual = Day21.answer2)
  }
  test("Day22") {
    assertResult(5256)(actual = Day22.answer1)
    assertResult(2511345)(actual = Day22.answer2)
  }
  test("Day23") {
    assertResult(3025)(actual = Day23.answer1)
    assertResult(915)(actual = Day23.answer2)
  }
  test("Day24") {
    assertResult(1511)(actual = Day24.answer1)
    assertResult(1471)(actual = Day24.answer2)
  }
