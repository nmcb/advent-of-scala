...
class TestSolutions extends AnyFunSuite:
  ...
  test("Day17 [3s]") {
    ...
    assertResult(1556521739139L)(actual = Day17.answer2)
  }
  test("Day18 [2s]") {
  ...
  test("Day23 [385s]") {
    ...
    assertResult(1055)(actual = Day23.answer2)
  }
  test("Day24 [5542ms]") {
    assertResult(292)(actual = Day24.answer1)
    assertResult(816)(actual = Day24.answer2)
  }
  test("Day25 [1ms]") {
    assertResult("2=112--220-=-00=-=20")(actual = Day25.answer1)
  }
  test("Day26 [5542ms]") {
    assertResult(20)(actual = Day26.answer10)
  }
